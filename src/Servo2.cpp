...
int Servo2::ServoCount = 0;

// The ChannelUsed array elements are 0 if never used, 1 if in use, and -1 if used and disposed
// (i.e., available for reuse)
int Servo2::ChannelUsed[MAX_SERVOS+1] = {0}; // we ignore the zeroth element

Servo2::Servo2(int channel)
{
...
int Servo2::attach(int pin, int min, int max)
{    
...
void Servo2::setTimerWidth(int value)
{
